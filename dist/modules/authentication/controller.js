...
import { changePasswordSchema, loginAuthenticationSchema, secondChangePasswordSchema, } from '@/modules/authentication/validator';
...
export async function login(req, res, next) {
    try {
        ...
        const refresh = jwt.sign(data, JWT_SECRET_REFRESH, { expiresIn: '1d' });
        res.addLogMeta({
            step: 'login success',
            email: user?.email,
            user: user?.firstName,
